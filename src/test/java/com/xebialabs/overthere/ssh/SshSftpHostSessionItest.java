...
public class SshSftpHostSessionItest extends SshHostSessionItestBase {

	@Override
	public void setupTargetHost() {
		targetHost = new Host();
		targetHost.setLabel("Itest Host for SSH/SFTP access");
	...
	public void hostSessionIsAnSshSftpHostSession() {
		assertEquals(SshSftpHostSession.class, session.getClass());
	}
