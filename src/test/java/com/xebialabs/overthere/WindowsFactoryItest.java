...
public class WindowsFactoryItest {
    ...
    private OverthereConnectionItest testCifsTelnetWithAdministrativeUser() throws Exception {
        ...
        return new OverthereConnectionItest(this.getClass().getName() + ".testCifsTelnetWithAdministrativeUser", CIFS_PROTOCOL, options, "com.xebialabs.overthere.cifs.telnet.CifsTelnetConnection", "overthere-windows");
    }
    ...
    private OverthereConnectionItest testCifsTelnetWithRegularUser() throws Exception {
        ...
        options.set(JUMPSTATION, createPartialTunnelOptions());
        return new OverthereConnectionItest(this.getClass().getName() + ".testCifsTelnetWithRegularUser", CIFS_PROTOCOL, options, "com.xebialabs.overthere.cifs.telnet.CifsTelnetConnection", "overthere-windows");
    }
    ...
    private OverthereConnectionItest testCifsWinRmHttpWithAdministrativeUser() throws Exception {
        ...
        options.set(CIFS_PORT, DEFAULT_CIFS_PORT);
        options.set(JUMPSTATION, createPartialTunnelOptions());
        return new OverthereConnectionItest(this.getClass().getName() + ".testCifsWinRmHttpWithAdministrativeUser", CIFS_PROTOCOL, options, "com.xebialabs.overthere.cifs.winrm.CifsWinRmConnection", "overthere-windows");
    }
    ...
    private OverthereConnectionItest testCifsWinRmHttpsWithAdministrativeUser() throws Exception {
        ...
        options.set(JUMPSTATION, createPartialTunnelOptions());
        return new OverthereConnectionItest(this.getClass().getName() + ".testCifsWinRmHttpsWithAdministrativeUser", CIFS_PROTOCOL, options, "com.xebialabs.overthere.cifs.winrm.CifsWinRmConnection", "overthere-windows");
    }
    ...
    private OverthereConnectionItest testSshSftpCygwinWithAdministrativeUser() throws Exception {
        ...
        options.set(PASSWORD, ADMINISTRATIVE_USER_ITEST_PASSWORD);
        options.set(JUMPSTATION, createPartialTunnelOptions());
        return new OverthereConnectionItest(this.getClass().getName() + ".testSshSftpCygwinWithAdministrativeUser", SSH_PROTOCOL, options, "com.xebialabs.overthere.ssh.SshSftpCygwinConnection", "overthere-windows");
    }
    ...
    private OverthereConnectionItest testSshSftpCygwinWithRegularUser() throws Exception {
        ...
        options.set(PASSWORD, REGULAR_USER_ITEST_PASSWORD);
        options.set(JUMPSTATION, createPartialTunnelOptions());
        return new OverthereConnectionItest(this.getClass().getName() + ".testSshSftpCygwinWithRegularUser", SSH_PROTOCOL, options, "com.xebialabs.overthere.ssh.SshSftpCygwinConnection", "overthere-windows");
    }
    ...
    private OverthereConnectionItest testSshSftpWinSshdWithAdministrativeUser() throws Exception {
        ...
        options.set(PASSWORD, ADMINISTRATIVE_USER_ITEST_PASSWORD);
        options.set(JUMPSTATION, createPartialTunnelOptions());
        return new OverthereConnectionItest(this.getClass().getName() + ".testSshSftpWinSshdWithAdministrativeUser", SSH_PROTOCOL, options, "com.xebialabs.overthere.ssh.SshSftpWinSshdConnection", "overthere-windows");
    }
    ...
    private OverthereConnectionItest testSshSftpWinSshdWithRegularUser() throws Exception {
        ...
        options.set(JUMPSTATION, createPartialTunnelOptions());
        return new OverthereConnectionItest(this.getClass().getName() + ".testSshSftpWinSshdWithRegularUser", SSH_PROTOCOL, options, "com.xebialabs.overthere.ssh.SshSftpWinSshdConnection", "overthere-windows");
    }
