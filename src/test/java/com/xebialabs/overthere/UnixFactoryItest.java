...
public class UnixFactoryItest {
    ...
    private OverthereConnectionItest testSshSftp() throws Exception {
        ...
        return new OverthereConnectionItest(this.getClass().getName() + ".testSshSftp", SSH_PROTOCOL, options, "com.xebialabs.overthere.ssh.SshSftpUnixConnection", "overthere-unix");
    }
    ...
    private OverthereConnectionItest testSshInteractiveSudo() throws Exception {
        ...
        return new OverthereConnectionItest(this.getClass().getName() + ".testSshInteractiveSudo", SSH_PROTOCOL, options, "com.xebialabs.overthere.ssh.SshInteractiveSudoConnection", "overthere-unix");
    }
