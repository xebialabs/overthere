...
public interface OverthereConnectionBuilder {
     ...
     * class. The first argument is a {@link String} that specifies the type (and is identical to the name field of the
     * {@link Protocol} annotation). The second argument is the {@link ConnectionOptions}.
     *
